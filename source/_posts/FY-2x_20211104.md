...
最后博主从网上找了个菱形天线的制作方法，依葫芦画瓢搞了个简陋馈源出来。
...
SDR 部分，CIA 探员不晓得从哪弄来个 Airspy Mini...... 能用就行。
...
博主用的 Debian 11，结果报错了，apt 显示 `libvolk1-dev` 没有候选项，只能拿 `libvolk2-dev` 代替（Ubuntu 也是如此）。

依赖补齐后，从源码编译 libnng-dev。
...
插入 Airspy Mini，将 SatDump 标签页切换到 Live processing，指定 Pipeline 为 FengYun-2 S-VISSR，然后选择云图输出目录。
...
| FY-2x_1 |  红外线  | 2291 x 2501 |
| FY-2x_1 |  水蒸气  | 2291 x 2501 |
| FY-2x_1 |  红外线  | 2291 x 2501 |
| FY-2x_1 |  红外线  | 2291 x 2501 |
